...
from geosim.core.nation import Nation, Currency
from geosim.core.economy import GlobalEconomy
from geosim.core.events import EventSystem
from geosim.core.combat import WarSystem
from geosim.core.geography import HexGrid, TerrainType
from geosim.core.diplomacy import UnitedNations
from geosim.utils.logger import setup_logger

logger = setup_logger()
from geosim.utils.config import SimulationConfig, GOVERNMENT_TYPES, NATION_NAME_PARTS
from geosim.visualization.viz import Visualizer
from geosim.interfaces.dashboard import Dashboard
from geosim.visualization.network_viz import NetworkVisualizer
...
class World:
    ...
    def _update_intelligence(self) -> List[str]:
        ...
        from geosim.core.intelligence import MissionType
        events = []
