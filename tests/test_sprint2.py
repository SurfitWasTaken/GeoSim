import pytest
import random
from geosim.core.nation import Nation
from geosim.core.world import World
from geosim.utils.config import SimulationConfig
from geosim.core.diplomacy import UnitedNations, AllianceType
from geosim.core.politics import FactionType, Faction
...
def test_un_voting(config):
    ...
    nations = []
    for i in range(10):
        from geosim.core.nation import Currency
        c = Currency(f"C{i}")
        n = Nation(
            id=i, 
            name=f"Nation{i}",
